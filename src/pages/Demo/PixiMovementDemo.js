...
const PixiMovementDemo = ({ walkSpeed, sprintSpeed, onStateChange, skinId }) => {
  ...
  useEffect(() => {
    const run = async () => {
      ...
      const scale = spriteInfo.render.scale || 2; // fallback default
  ...
  }, [walkSpeed, sprintSpeed, onStateChange, skinId]); // ✅ rerun if skinId changes
