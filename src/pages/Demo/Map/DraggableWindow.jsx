  ...
  useEffect(() => {
    const handleMouseMove = (e) => {
      if (isDragging) {
        ...
        setSize(prevSize => ({
          width: resizeDirection.x ? Math.max(minWidth, prevSize.width + deltaX) : prevSize.width,
          height: resizeDirection.y ? Math.max(minHeight, prevSize.height + deltaY) : prevSize.height
        }));
      }
    };
